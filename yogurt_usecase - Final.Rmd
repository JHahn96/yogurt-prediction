...
ges<-auto.arima(trainingg, ic = "aic")
Jog<-auto.arima(trainingg, ic = "aic")
ges.pred <- predict(ges, n.ahead = 12)
Jog.pred <- predict(Jog, n.ahead = 12)
...
# refactor columns for prophet package
  ...
  testingA<-mod$coefficients[1]+mod$coefficients[2]*as.numeric(testing$week)+mod$coefficients[3]*as.numeric(testing$month)+mod$coefficients[4]*as.numeric(testing$promo_01)+
    mod$coefficients[5]*as.numeric(testing$promo_02)+mod$coefficients[6]*as.numeric(testing$promo_03)+mod$coefficients[7]*as.numeric(testing$promo_04)+mod$coefficients[8]*as.numeric(testing$promo_05)+mod$coefficients[9]*as.numeric(testing$Joghurt)+mod$coefficients[10]*as.numeric(testing$gesund.essen)+mod$coefficients[11]*as.numeric(testing$yogurtpreis)+mod$coefficients[12]*as.numeric(testing$milchpreis)+mod$coefficients[13]*as.numeric(testing$year)
